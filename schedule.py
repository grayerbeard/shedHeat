...
class class_schedule:
	...
	def calcTargets(self,hourInDay):
	...
	def testPrint(self,start,end,step):
		# set up an array of times to display
		hoursArray = np.arange(start,end,step)
		# print headings
		print("Time  Open/Closed  Desired   TargetHp  TargetHtrs") 
		for _, hourInDay in enumerate(hoursArray):
			...
			# print values
			print("  ",hourInDay,"  ", shedStatus,"  ",  desiredTemp,"  ",targetHp,"  ",targetHeaters)
...
if __name__ == '__main__':
	...
	step = 0.25
	schedule.testPrint(start,end,step)
