...
class class_config:
	def __init__(self,configFileName):
		...
		self.codes2 = config_read.get(section, 'codes2').split(",")
		self.values2 = config_read.get(section, 'values2').split(",")
		self.values2Types = config_read.get(section, 'values2Types').split(",")
		self.codes3 = config_read.get(section, 'codes3').split(",")
		self.values3 = config_read.get(section, 'values3').split(",")
		self.values3Types = config_read.get(section, 'values3Types').split(",")
		self.codes4 = config_read.get(section, 'codes4').split(",")
		self.values4 = config_read.get(section, 'values4').split(",")
		self.values4Types = config_read.get(section, 'values4Types').split(",")
		self.codes5 = config_read.get(section, 'codes5').split(",")
		self.values5 = config_read.get(section, 'values5').split(",")
		self.values5Types = config_read.get(section, 'values5Types').split(",")
		self.codes6 = config_read.get(section, 'codes6').split(",")
		self.values6 = config_read.get(section, 'values6').split(",")
		self.values6Types = config_read.get(section, 'values6Types').split(",")
		self.codes7 = config_read.get(section, 'codes7').split(",")
		self.values7 = config_read.get(section, 'values7').split(",")
		self.values7Types = config_read.get(section, 'values7Types').split(",")
		self.codes8 = config_read.get(section, 'codes8').split(",")
		self.values8 = config_read.get(section, 'values8').split(",")
		self.values8Types = config_read.get(section, 'values8Types').split(",")
		self.codes9 = config_read.get(section, 'codes9').split(",")
		self.values9 = config_read.get(section, 'values9').split(",")
		self.values9Types = config_read.get(section, 'values9Types').split(",")
		self.deviceNumberHeaters = config_read.getint(section, 'deviceNumberHeaters')
		self.deviceNumberCircFan = config_read.getint(section, 'deviceNumberCircFan')
		...
		self.deviceNumberx7 = config_read.getint(section, 'deviceNumberx7')
		self.deviceNumberx8 = config_read.getint(section, 'deviceNumberx8')
		self.deviceNumberx9 = config_read.getint(section, 'deviceNumberx9')
